...
impl WorkspaceManager
{
    ...
    -> Fallible<()>
    {
        let target = self.move_workspaces(connection, direction)?;
    ...
    pub fn create_workspace_move_window(
        self,
    ...
    fn move_workspaces(self, connection: &mut Connection, direction: Direction) -> Fallible<i32>
    {
